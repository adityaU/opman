...
pub(super) fn status_icon_color<'a>(
...
pub(super) fn priority_arrow(priority: &str) -> &'static str {
    match priority {
        "high" => "↑",
        "medium" => "→",
        "low" => "↓",
...
pub(super) fn priority_color(priority: &str, is_selected: bool, _theme: &ThemeColors) -> Color {
    match priority {
        "high" => Color::Red,
        "medium" => Color::Yellow,
        "low" => Color::Green,
