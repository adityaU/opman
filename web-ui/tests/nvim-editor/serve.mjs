...
const tempRoot = mkdtempSync(join("/tmp", "opman-nvim-e2e-"));
...
const nvimConfig = join(configHome, "opman-nvim-e2e");
mkdirSync(workspace, { recursive: true });
mkdirSync(join(configHome, "opman"), { recursive: true });
mkdirSync(nvimConfig, { recursive: true });
...
writeFileSync(join(nvimConfig, "init.lua"), [
