...
export const PALETTE_COMMANDS: readonly CommandDef[] = [
  { id: "palette.commands", title: "Show All Commands", category: "Palette", label: "commands" },
  ...
  { id: "palette.searchAll", title: "Search All Sessions…", category: "Palette", label: "search all" },
...
export const LAYOUT_COMMANDS: readonly CommandDef[] = [
  { id: "layout.toggleSidebar", title: "Toggle Sidebar", category: "Layout", label: "sidebar" },
  { id: "layout.toggleTerminal", title: "Toggle Terminal Panel", category: "Layout", label: "terminal" },
